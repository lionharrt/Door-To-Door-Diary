...
exports.generateColumnFilters = exports.generateFilterObj = exports.getDefaultFilteredColumns = exports.setStorageFilters = exports.setDefaultFilters = exports.clearDefaultFilterValues = exports.setupTableColumns = undefined;
 ...
 */
var clearDefaultFilterValues = exports.clearDefaultFilterValues = function clearDefaultFilterValues(tableColumns) {
    return Object.values(tableColumns).forEach(function (filter) {
        filter.resetDefault();
    });
};
...
var setStorageFilters = exports.setStorageFilters = function setStorageFilters(tableColumns, filters) {
    return Object.values(tableColumns).filter(function (filter) {
        ...
        return _extends({}, object, _defineProperty({}, filter.column.key, filters[filter.column.key]));
    }, {});
};
 ...
 */
var generateFilterObj = exports.generateFilterObj = function generateFilterObj(tableColumns) {
    return getDefaultFilteredColumns(tableColumns).reduce(function (object, filter) {
        return _extends({}, object, _defineProperty({}, filter.column.key, filter.toFilterItem()));
    }, {});
};
...
var generateColumnFilters = exports.generateColumnFilters = function generateColumnFilters(tableColumns, filters) {
    return Object.entries(filters).map(function (_ref3) {
        ...
        return tableColumns[key].generateColumnFilter(filter.value);
    });
};