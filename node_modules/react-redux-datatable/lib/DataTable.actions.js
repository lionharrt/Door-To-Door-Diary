...
exports.resetExport = resetExport;
...
var dispatchError = function dispatchError(dispatch, dispatchType, tableSettings, error) {
    return dispatch({
...
function fetchTableData(tableSettings, limit, offset, sortName, sortOrder, searchValue, columnFilters, apiLocation) {
    return function (dispatch) {
        var dispatchType = 'FETCH_TABLE_DATA';
...
function resetExport(tableID) {
    return function (dispatch) {
        dispatch({
            type: 'FETCH_EXPORT_TABLE_DATA_RESET',
            payload: {
                tableId: tableID,
                tableData: _defineProperty({}, tableID, {
                    fetching: false,
                    fetched: false,
                    error: null,
                    data: null,
