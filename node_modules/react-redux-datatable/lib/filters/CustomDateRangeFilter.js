...
var CustomDateRangeFilter = function (_ColumnFilter) {
    ...
    function CustomDateRangeFilter() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CustomDateRangeFilter.__proto__ || Object.getPrototypeOf(CustomDateRangeFilter)).call.apply(_ref, [this].concat(args))), _this), _this.setDefault = function (value) {
            if (value.values) {
            ...
            return _this.generateCustomFilter(value);
        }, _this.getCustomFilter = function (filterHandler, customFilterParameters) {
