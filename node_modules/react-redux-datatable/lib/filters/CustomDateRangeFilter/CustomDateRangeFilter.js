...
var CustomDateFilter = function (_React$Component) {
    ...
    function CustomDateFilter(props) {
        ...
        _this.customCleanFiltered = function () {
            _this.setState({
                from: null,
                to: null,
                displayValue: ''
            });
            _this.props.filterHandler(); // clear filter
        };

        _this.filter = function () {
            if (_moment2.default.isDate(_this.state.from)) {
                var fromValue = (0, _moment2.default)(_this.state.from).format('YYYY-MM-DD');
                var toValue = void 0;
                if (_moment2.default.isDate(_this.state.to)) {
                    _this.setDisplayValue(_this.state.from, _this.state.to);
                    toValue = (0, _moment2.default)(_this.state.to).hours(23).minutes(59).seconds(59).format('YYYY-MM-DD HH:mm:ss');
                } else {
                    _this.setDisplayValue(_this.state.from, _this.state.from);
                    toValue = (0, _moment2.default)(_this.state.from).hours(23).minutes(59).seconds(59).format('YYYY-MM-DD HH:mm:ss');
                }
    ...
    _createClass(CustomDateFilter, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { id: columnKey + '-date-filter', className: 'custom-date-filter filter' },
...
CustomDateFilter.propTypes = {
    ...
    defaultValue: _propTypes2.default.object.isRequired
};
