...
var propTypes = {
  ...
  primaryKey: _propTypes2.default.string.isRequired,
  selectable: _propTypes2.default.bool,
  selectEnabled: _propTypes2.default.func,
  className: _propTypes2.default.string,
  styleName: _propTypes2.default.string,
  CheckboxComponent: _propTypes2.default.func,
  NoDataComponent: _propTypes2.default.func
};

var resolveHeaderCondition = function resolveHeaderCondition(col, tableProps) {
  if (!col || !col.headerComponentVisible) {
    return false;
  } else if (_lodash2.default.isFunction(col.headerComponentVisible)) {
    return col.headerComponentVisible(tableProps);
  } else if (_lodash2.default.isBoolean(col.headerComponentVisible)) {
    return col.headerComponentVisible;
  }
  throw new Error('Header\'s headerComponentVisible should be a function or a boolean!');
};

var omitHeaderProps = function omitHeaderProps(props) {
  return _lodash2.default.omit(props, ['data', 'filter', 'primaryKey', 'selectable', 'selectEnabled', 'className', 'styleName', 'CheckboxComponent', 'NoDataComponent']);
};
        ...
        headers && _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            visibleColumns.map(function (col) {
              ...
              if (!hidden && HeaderComponent && resolveHeaderCondition(col, _this2.props)) {
                return _react2.default.createElement(
                  'th',
                  null,
                  _react2.default.createElement(col.HeaderComponent, _extends({}, omitHeaderProps(_this2.props), {
                    key: key,
                    title: title
                  }))
                );
