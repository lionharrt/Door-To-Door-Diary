...
exports.default = function (tableName) {
  ...
  var tableOrComponentProp = function tableOrComponentProp(state, props, prop) {
  ...
  var getPageSize = function getPageSize(state, props) {
    return tableOrComponentProp(state, props, 'pageSize');
  };
