...
var propTypes = {
  ...
  isInitialized: _propTypes2.default.bool.isRequired,
  visibleRows: _propTypes2.default.array,
  filter: _propTypes2.default.array,
  sortInfo: _propTypes2.default.object,
  ...
  filterOptions: _propTypes2.default.array,
  filterValue: _propTypes2.default.array,
  ...
  onInitialize: _propTypes2.default.func.isRequired,
  onNewData: _propTypes2.default.func.isRequired,
  onNewFilterValue: _propTypes2.default.func.isRequired,
  onRowCheckedChange: _propTypes2.default.func.isRequired,
  onSelectAllChange: _propTypes2.default.func.isRequired
};
    ...
    _createClass(DataTable, [{
      ...
      value: function render() {
        ...
        var _configs$showPageSize = configs.showPageSize,
            ...
            _configs$showPaginati = configs.showPagination,
            showPagination = _configs$showPaginati === undefined ? true : _configs$showPaginati,
        ...
        if (configs.plain) {
          return _react2.default.createElement(TableComponent, _extends({}, otherProps, {
            data: visibleRows,
            headers: headers,
